...
#### Extend to 13 Windows

**Current state**: 12 windows
**Target state**: 13 windows (Dec 12-24)

**File**: `/src/config/calendar-content.ts`

Update the `defaultCalendarContent` array:
...
export const defaultCalendarContent: CalendarContent[] = [
  ...
  // ... continue through day 13
  {
    ...
    type: 'message', // Make the finale special!
    title: 'Christmas Eve',
    // ... NEW CONTENT NEEDED
  },
];
...
- Time is 00:00:00 (midnight)
- Browser will interpret as local timezone
- Need to create content for window 13
...
|----------|----------|------|-----------|
| 12 or 13 windows? | 13 (Dec 12-24) | 2025-11-22 | Matches Dec 12-24 range |
...
| Window numbering? | 1-13 (not 12-24) | 2025-11-22 | Simpler implementation |
